...
const replaceWords = (str) => {
    // write your code here
    let replacementArray = str.split(" ");
    if (replacementArray[0] === "I" || replacementArray[0] === "i" ) {
        replacementArray.splice(0, 1, "We");
    } if (replacementArray[1] === "am") {
        replacementArray.splice(1, 1, "are");
    } else if (replacementArray[1] === "was") {
        replacementArray.splice(1, 1, "were");
    }
